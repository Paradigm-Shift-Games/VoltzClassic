...
local module = {}
local Settings = require(script.Settings.selectedSettings.Value)
...
module.Generate = function() -- will take a datastore at some point
	...
	Picker.Initialize()
	Welder.Initialize()
	workspace.MapCells.Parent = game.ReplicatedStorage
