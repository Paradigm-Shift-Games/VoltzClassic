...
WinService.sendMatchResultAndUpdateRatings = function(livingTeamCount, lastTeam, remainingTeams)
	--if #PlayersService:GetPlayers() <= 1 and #game.Teams:GetTeams() <= 1 then return end
